...
export const threatEventTextConfig = {
  title: {
    [THREAT_EVENT_EXPLOIT]: <span> <ExtraIcon type="bug"></ExtraIcon> &nbsp;&nbsp;{"攻擊利用漏洞"}</span>,
    [THREAT_EVENT_TOOL]: <span><ExtraIcon type="eyedropper"></ExtraIcon>&nbsp;&nbsp;{"攻擊武器（家族）"}</span>,
    [THREAT_EVENT_THREAT_INFO]: <span><Icon type="file-text"></Icon>&nbsp;&nbsp;{"威脅情報"}</span>
  }
}
