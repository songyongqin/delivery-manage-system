      ...
      <Form style={{ height: "100%", overflowY: "scroll", overflowX: "hidden" }}>
            ...
            keyName={HONEYPOT_NAME_DATAINDEX} />}>
          {
            getFieldDecorator(
              HONEYPOT_NAME_DATAINDEX,
              {
                ...
                rules: [
                  {
                    required: true, message: '蜜罐名稱不能為空',
                  },
                  {
            ...
            keyName={HONEYPOT_IP_DATAINDEX} />}>
          {
            getFieldDecorator(
              HONEYPOT_IP_DATAINDEX,
              {
                ...
                rules: [
                  {
                    required: true, message: '蜜罐IP不能為空',
                  },
                  {
            ...
            keyName={GATEWAY_DATAINDEX} />}>
          {
            getFieldDecorator(
              GATEWAY_DATAINDEX,
              {
                ...
                rules: [
                  {
                    required: true, message: '蜜罐網關不能為空',
                  },
                  {
            ...
            keyName={SUBNET_DATAINDEX} />}>
          {
            getFieldDecorator(
              SUBNET_DATAINDEX,
              {
                ...
                rules: [
                  {
                    required: true, message: '子網掩碼不能為空',
                  },
                  {
        ...
        <FormItem  {...commonProps}
          ...
          label={activeInteraction === HIGH_INTERATION ? <Label className={lblClasses}
            keyName={SYSTEM_DATAINDEX} /> : <span className={lblClasses}>模擬設備類型</span>}>
          {
            getFieldDecorator(
              SYSTEM_DATAINDEX,
              {
            ...
            keyName={SERVICES_DATAINDEX} />}>
          {
            getFieldDecorator(
              SERVICES_DATAINDEX,
              {
                ...
                rules: [
                  {
                    required: true, message: '服務支持不能為空',
                  }
                ]
              }
            )
        ...
        <FormItem {...tailFormItemLayout}>
          <Button type="primary"
            loading={loading}
            icon="plus"
            onClick={this.handleSubmit}>創建</Button>
        </FormItem>
      </Form>
    );
  }
