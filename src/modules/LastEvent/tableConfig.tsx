...
const locale = {
  [ATTACK_TIMES_DATA_INDEX]: "攻擊時間",
  [ATTACK_STAGE_DATA_INDEX]: "攻擊階段",
  [ACTION_DATA_INDEX]: "行為",
  [LEVEL_DATA_INDEX]: "威脅等級",
  [EVENT_TYPE_DATA_INDEX]: "事件類型",
  [ACTION_STATUS_DATA_INDEX]: "操作狀態",
  [DES_DATA_INDEX]: "威脅描述"
}
    ...
    return (
      <Choose>
        ...
        <When condition={value === 0}>
          <span><Badge status="error"></Badge>失敗</span>
        </When>
        <Otherwise>
