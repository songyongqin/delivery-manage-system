        ...
        <FormItem {...formItemLayout}
          ...
          {getFieldDecorator("ip", {
            ...
            rules: [
              ...
              {
                pattern: ipReg, message: "请输入正确的IP"
              }
            ]
          })(
...
@extraConnect(
  state => {
    ...
    return {
      loading: effectsLoading[`${SYS_CONFIG_NETWORK_MASTER_NAMESPACE}/fetch`] ||
        effectsLoading[`${SYS_CONFIG_NETWORK_MASTER_NAMESPACE}/put`]
    }
  },
  dispatch => {
    return {
      fetch: _ => dispatch({
        type: `${SYS_CONFIG_NETWORK_MASTER_NAMESPACE}/fetch`,
      }),
      put: payload => dispatch({
        type: `${SYS_CONFIG_NETWORK_MASTER_NAMESPACE}/put`,
        payload
      })
    }
  }
...
export default class extends React.Component<any, any>{
  ...
  fetchData = () => {
    return this.props.fetch()
      .then(res => this.setState({ data: { ip: res }, initial: true }))
  }
  onSubmit = payload => {
  ...
  render() {
    ...
    return (
      <Card
        title={
          <div>
            <Icon type="setting"></Icon> &nbsp;控制中心IP认证配置&nbsp;&nbsp;
          </div>
