      ...
      <div>
        {
          data.map((i, index) => {
            ...
            // >
              ...
              <Tox86_sandbox_report md5={md5} x86_analysis_status={x86_analysis_status}></Tox86_sandbox_report>
              :
              <Card
                key={index}
                title={keys}
        ...
        <ToNon_x86_sandbox_report md5={md5} nox86_analysis_status={nox86_analysis_status}></ToNon_x86_sandbox_report>
      </div>
    )
  }
}
