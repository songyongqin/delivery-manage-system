...
@WithAnimateRender
@WithCommonProps
class DeliveryChecklistUpd extends React.Component<any, any> {
  ...
  render() {
    ...
    const {expirationDate, examiner, inspectionTime, remarks, enclosures=[]} = this.props.data
    let initArr = []
    enclosures.map(el => {
      initArr.push(el.id)
    })
...
export default Form.create()(DeliveryChecklistUpd)
