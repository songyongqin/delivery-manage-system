...
const textConfig = {
  ...
  items: {
    [COUNTS_DATA_INDEX]: "攻擊次數",
    [HIGH_EVENTS_DATA_INDEX]: "攻擊高危次數",
    [EXPLOITS_DATA_INDEX]: "攻擊利用漏洞",
    [TOOLS_DATA_INDEX]: "攻擊武器",
    [THREAT_INFOS_DATA_INDEX]: "威脅情報",
    [FALL_HOST_DATA_INDEX]: "失陷主機"
  },
  units: {
    [COUNTS_DATA_INDEX]: "次",
    [HIGH_EVENTS_DATA_INDEX]: "起",
    [EXPLOITS_DATA_INDEX]: "個",
    [TOOLS_DATA_INDEX]: "個",
    [THREAT_INFOS_DATA_INDEX]: "條",
