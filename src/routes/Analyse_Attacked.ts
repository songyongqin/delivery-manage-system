...
export default (app: any, url: string): React.Component => {
  ...
  return dynamic({
    ...
    models: () => [
      ...
      System.import(/* webpackChunkName: "AnalyseViewModel" */'modules/Analyse_Attacked/model'),
      System.import(/* webpackChunkName: "AnalyseCountModel" */'modules/Analyse_Attacked/components/Count/model'),
    ].map(asyncModulePipe),
    component: () => System.import(/* webpackChunkName: "AnalyseAttackedPage" */'modules/Analyse_Attacked')
