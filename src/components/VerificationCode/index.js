...
export default class extends React.Component {
  ...
  // }
  renderCode = () => {
    const { value = "verification code", disturb = false, isDark = false } = this.props;
  ...
  render = () => {
    ...
    return <div
      style={{ width: "120px", cursor: "pointer", border: isDark ? "1px solid white" : "1px solid black" }}>
      <canvas onClick={this.props.onClick} ref={target => this.canvas = target} width="120px" height="35px"></canvas>
    </div>
